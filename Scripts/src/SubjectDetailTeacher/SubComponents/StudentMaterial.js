...
const StudentMaterial = ({ material, deleteMaterial, info, showPopup}) => {
    return (       
        <div class="student-material-container">
            ...
            {material ? <MaterialContainer materials={material} info={info} deleteMaterial={deleteMaterial }/> : <p class="alert alert-dark my-1 w-100">Zatím jste nepřidal/a žádné studijní materiály 🙁</p>}
        </div>        
    )
}
